...
\begin{center}\small
	\begin{longtable}{p{0.5\textwidth}p{0.45\textwidth}}
		...
		%============================================================================================  
		\pagebreak
		\multicolumn{2}{c}{\cellcolor{themecolorlight}\bfseries Металева сфера в однорідному електричному полі}                                                          \\
		...
		\begin{center}
			\input{Spheres/EfieldMetall.tikz}
		\end{center}
		...
		\\
		\multicolumn{2}{c}{\cellcolor{themecolorlight}\bfseries Провідна куля в середовищі по якому тече струм. Задача~\ref{sphere:current_in_media}}                    \\
		...
		\\
		\pagebreak
		\multicolumn{2}{c}{\cellcolor{themecolorlight}\bfseries Куля з магнетика в однорідному магнітному полі. Задача~\ref{sphere:Magnetic_in_magnetic}}                \\
		...
		\\
		\multicolumn{2}{c}{\cellcolor{themecolorlight}\bfseries Надпровідна куля в однорідному магнітному полі $\Bfield_0$. Задача~\ref{sphere:Superconductor_in_field}} \\
